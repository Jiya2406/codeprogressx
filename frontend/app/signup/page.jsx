  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6">
      <div className="glass-card w-full max-w-md rounded-3xl p-8 md:p-10 shadow-soft">
        ...
        <p className="text-gray-600 text-sm mb-7">Start tracking your Codeforces progress in under a minute.</p>
        ...
        <p className="text-sm text-gray-600 text-center mt-6">
          ...
          <Link href="/login" className="text-lavender-500 font-medium hover:underline">
            Log in
          </Link>
        </p>
      </div>
